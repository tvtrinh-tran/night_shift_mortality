...
#-----------------------------------------------------------------------------------------------------------------------------
var_label_night_shift_rotating = list("night_rotating_age_start_cat" ~ "Age at start rotating night shift work")
...
## Table 3: Dose-response relationship between total duration of permanent night shift work, cumulative permanent night shifts and all-cause, cardiovascular disease, and cancer mortality by permanent night shift intensity
...
lung_cancer_night_shift_all=cox_model(surv = "Surv(ENTRY_AGE, EXIT_AGE, MOR_LUNG_MODIF)",
                             var_name = var_name_night_shift_all[1],
                             var_label = var_label_night_shift_all[1],
                             covar = covariates_night_shift,
                             data=night_shift_popu)|> modify_table_body(~ .x  |>
                             dplyr::add_row(label = "Lung cancer mortality",.before=1))
lung_cancer_night_shift_perm=cox_model(surv = "Surv(ENTRY_AGE, EXIT_AGE, MOR_LUNG_MODIF)",
                             var_name = var_name_night_shift_cause_specific,
                             var_label = var_label_night_shift_cause_specific,
                             covar = covariates_night_shift,
                             data=night_shift_popu_exclude_rotating)

breast_cancer_night_shift_all=cox_model(surv = "Surv(ENTRY_AGE, EXIT_AGE, MOR_BREAST_MODIF)",
                             var_name = var_name_night_shift_all[1],
                             var_label = var_label_night_shift_all[1],
                             covar = covariates_night_shift,
                             data=night_shift_popu[night_shift_popu$sex=="Female",])|> modify_table_body(~ .x  |>
...
breast_cancer_night_shift_perm=cox_model(surv = "Surv(ENTRY_AGE, EXIT_AGE, MOR_BREAST_MODIF)",
                             ...
                             var_label = var_label_night_shift_cause_specific,
                             covar = covariates_night_shift,
                             data=night_shift_popu_exclude_rotating[night_shift_popu_exclude_rotating$sex=="Female",])

pancreas_cancer_night_shift_all=cox_model(surv = "Surv(ENTRY_AGE, EXIT_AGE, MOR_PANCREAS_MODIF)",
                             var_name = var_name_night_shift_all[1],
                             var_label = var_label_night_shift_all[1],
                             covar = covariates_night_shift,
                             data=night_shift_popu)|> modify_table_body(~ .x  |>
                             dplyr::add_row(label = "Pancreas cancer mortality",.before=1))
...
colon_cancer_night_shift_all=cox_model(surv = "Surv(ENTRY_AGE, EXIT_AGE, MOR_COLON_MODIF)",
                             var_name = var_name_night_shift_all[1],
                             var_label = var_label_night_shift_all[1],
                             covar = covariates_night_shift,
                             data=night_shift_popu)|> modify_table_body(~ .x  |>
                             dplyr::add_row(label = "Colon cancer (excluding rectum) mortality",.before=1))
colon_cancer_night_shift_perm=cox_model(surv = "Surv(ENTRY_AGE, EXIT_AGE, MOR_COLON_MODIF)",
                             var_name = var_name_night_shift_cause_specific,
                             var_label = var_label_night_shift_cause_specific,
                             covar = covariates_night_shift,
                             data=night_shift_popu_exclude_rotating)
hypertension_night_shift_all=cox_model(surv = "Surv(ENTRY_AGE, EXIT_AGE, MOR_HYPERTENSION_MODIF)",
                             var_name = var_name_night_shift_all[1],
                             var_label = var_label_night_shift_all[1],
                             covar = covariates_night_shift,
                             data=night_shift_popu)|> modify_table_body(~ .x  |>
                             dplyr::add_row(label = "Hypertension without heart disease mortality",.before=1))
...
cause_specific = tbl_stack(list(lung_cancer_night_shift_all,lung_cancer_night_shift_perm,
                                breast_cancer_night_shift_all,breast_cancer_night_shift_perm,
                                pancreas_cancer_night_shift_all,pancreas_cancer_night_shift_perm, 
                                colon_cancer_night_shift_all,colon_cancer_night_shift_perm, 
                                hypertension_night_shift_all,hypertension_night_shift_perm ))
...
all_cause_interaction = tbl_stack(list(all_cause_strat_all,all_cause_strat_dur,all_cause_strat_dur_cont,all_cause_strat_cumulative,all_cause_strat_cumulative_cont,all_cause_strat_intensity,all_cause_strat_intensity_cont))
...
cvd_interaction = tbl_stack(list(cvd_strat_all,cvd_strat_dur,cvd_strat_dur_cont,cvd_strat_cumulative,cvd_strat_cumulative_cont,cvd_strat_intensity,cvd_strat_intensity_cont))
